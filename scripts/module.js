...
(function(window, undefined) {
    ...
    function updateData(data, newData) {
        ...
        firstItem = Object.keys(data)[0];
        if (firstItem.indexOf('#') === 0) {
            setDataValue(this.__data__, firstItem, data[firstItem]);
    ...
    var api = expandDescriptor({
         ...
         * @type {Object}
         */
        // TODO:  Make data an all-consuming accessor function.  It takes
        // objects, JSON strings, single values, and JSON fragments.  Objects
        // are merged on a key/value pair basis or as a result of an incoming
        // JSON fragment.
        data : {
            cfg : false,
            enm : false,
         ...
         * @type {Element}
         */
        __element__ : { val : null, wrt : true, cfg : true, enm : false },

        /**
         * A clone of the DOM element prior to the application of a module
         * @type {Element}
         */
        __previousElement__ : { val : null, wrt : true, cfg : true, enm : false },
